...
using UnityEngine;
public class ControlaZumbiEspecial : MonoBehaviour, IMatavel
{
    ...
    private StatusZumbiEspecial meuStatusInimigo;
    ...
    void Start()
    {
        ...
        meuStatusInimigo = GetComponent<StatusZumbiEspecial>();
        AleatorizarZumbi();
